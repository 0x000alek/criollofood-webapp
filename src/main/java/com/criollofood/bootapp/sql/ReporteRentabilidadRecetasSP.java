...
@Component
public class ReporteRentabilidadRecetasSP extends StoredProcedure {

    public ReporteRentabilidadRecetasSP(@Autowired DataSource dataSource) {
        super(dataSource, "REPORTE_RENTABILIDAD_RECETAS");
