...
@Component
public class CancelarReservacionSP extends StoredProcedure {

    public CancelarReservacionSP(@Autowired DataSource dataSource) {
        super(dataSource, "CANCELAR_RESERVACION");
