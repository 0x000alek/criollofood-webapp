...
@Component
public class FindReservacionesByIdCliente extends StoredProcedure {

    public FindReservacionesByIdCliente(@Autowired DataSource dataSource) {
        super(dataSource, "FIND_RESERVACIONES_BY_ID_CLIENTE");
